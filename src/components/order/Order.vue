...
<!-- 		<el-dialog
		  ...
		  <template #footer>
		    <span class="dialog-footer">
		      <el-button @click="proressVisible = false">取 消</el-button>
		      <el-button type="primary" @click="proressVisible = false">确 定</el-button>
		    </span>
		  </template>
		</el-dialog> -->
	</div>
		...
		data(){
			return {
				...
				addressFormRules:{
					address1: [
					{
						require: true, message: '请输入省市区县', trigger: 'blur'
					}],
					address2: [
					{
